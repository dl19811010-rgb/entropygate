import{E as S,s as f,y as p,aF as C,A as h,d as x,m as r,aZ as T,Y as $,L as k,O as v,P as w,R,p as m,r as O,a_ as P,a$ as j,U as B}from"./index-CRYXIsvh.js";import{u as L}from"./Space-DOsY5xaG.js";function N(e){const{opacityDisabled:a,heightTiny:t,heightSmall:s,heightMedium:l,heightLarge:n,heightHuge:c,primaryColor:o,fontSize:i}=e;return{fontSize:i,textColor:o,sizeTiny:t,sizeSmall:s,sizeMedium:l,sizeLarge:n,sizeHuge:c,color:o,opacitySpinning:a}}const V={common:S,self:N},E=f([f("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
