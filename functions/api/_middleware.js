// Cloudflare Pages _middleware.js — intercept all /api/* requests
// This runs before any route-specific function
...
export async function onRequest(context) {
  ...
  // Only handle /api/* routes - pass everything else through
  ...
  // Extract route after /api/ and build upstream URL
